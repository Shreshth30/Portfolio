...
script.onload = function() {
    ...
    sr.reveal('#experience .mb-16', { 
        interval: 300,
        origin: 'right',
        distance: '50px'
    });
    
    sr.reveal('#experience .group', { 
        interval: 300,
        origin: 'right',
        distance: '50px'
    });
